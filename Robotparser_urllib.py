...
# PyPi: https://docs.python.org/3/library/urllib.robotparser.html

"""
This module provides a single class, RobotFileParser, which answers questions about whether or not
a particular user agent can fetch a URL on the Web site that published the robots.txt file.
...
"""
 class urllib.robotparser.RobotFileParser(url='')
    ...
    crawl_delay(useragent)
        ...
        If there is no such parameter or it doesn’t apply to the useragent specified or the robots.txt entry
    ...
    request_rate(useragent)
        ...
        Returns the contents of the Request-rate parameter from robots.txt as a named tuple RequestRate(requests, seconds).
        If there is no such parameter or it doesn’t apply to the useragent specified or the robots.txt
    ...
    site_maps()
        ...
        If there is no such parameter or the robots.txt entry for this parameter has invalid syntax, return None.
"""
