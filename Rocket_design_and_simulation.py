#  rocketPy - Rocket design, simulation and analysis using Python !

#  Docs: https://rocketPy.readthedocs.io
#  Giyhub: https://github.com/dev10110/rocketPy
...
# create the fins
fins = rp.FinSet(name='Fins', n=3, span=6*ureg.inch, root_chord=12*ureg.inch, tip_chord=6*ureg.inch,
                 mid_sweep=10*ureg.degree, tube_dia=6*ureg.inch,  thickness=2*ureg.mm, material=rp.materials.Aluminium())
# define its location
